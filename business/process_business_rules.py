...
class BusinessRecommendationEngine:
    ...
    def __init__(self):
        """
        Initialize every business module.
        """
    ...
    def process_business_rules(
        ...
        retrieved_products : list
            Products returned by retrieval.py.
        ...
        -------
        dict
            Final business result + LLM answer.
        """
        ...
        if not self.tree.category_exists(category):
            ...
            business_result = {
                ...
                "system_prompt":
                    self.guardrails.build_system_rules()
        ...
        # ==================================================
        # STEP 2
        # Verify minimum conversation length
        # ==================================================
        ...
        if turn_count < 3:
            ...
            business_result = {
                ...
                "reason":
                    "At least three conversation turns are required before recommending a product.",
        ...
        # ==================================================
        # STEP 5
        # Apply stock validation
        # ==================================================

        validated_products = self.stock.replace_if_needed(
            retrieved_products
        )
        ...
        if len(final_products) == 0:
            ...
            if len(unavailable_products) > 0:
                ...
                business_result = {
                    ...
                    "reason":
                        "Matching products exist but are unavailable and no replacement product exists.",
                ...
                business_result = {
                    ...
                    "reason":
                        "No products remain after business validation.",
        ...
        business_result = {
            ...
            "reason":
                "Business rules successfully validated.",
        ...
        # ==================================================
        # STEP 9
        # Generate the final recommendation with Llama
        # ==================================================
